...
$TodosResponseCopyWith<TodosResponse> get copyWith => _$TodosResponseCopyWithImpl<TodosResponse>(this as TodosResponse, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TodosResponse&&const DeepCollectionEquality().equals(other.todos, todos)&&(identical(other.total, total) || other.total == total)&&(identical(other.skip, skip) || other.skip == skip)&&(identical(other.limit, limit) || other.limit == limit));
}
...
abstract mixin class $TodosResponseCopyWith<$Res>  {
  factory $TodosResponseCopyWith(TodosResponse value, $Res Function(TodosResponse) _then) = _$TodosResponseCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TodosResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TodosResponse value)  $default,){
final _that = this;
switch (_that) {
case _TodosResponse():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TodosResponse value)?  $default,){
final _that = this;
switch (_that) {
case _TodosResponse() when $default != null:
return $default(_that);case _:
...
class _TodosResponse implements TodosResponse {
  const _TodosResponse({required final  List<Todo> todos, required this.total, required this.skip, required this.limit}): _todos = todos;
  factory _TodosResponse.fromJson(Map<String, dynamic> json) => _$TodosResponseFromJson(json);
...
@pragma('vm:prefer-inline')
_$TodosResponseCopyWith<_TodosResponse> get copyWith => __$TodosResponseCopyWithImpl<_TodosResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TodosResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TodosResponse&&const DeepCollectionEquality().equals(other._todos, _todos)&&(identical(other.total, total) || other.total == total)&&(identical(other.skip, skip) || other.skip == skip)&&(identical(other.limit, limit) || other.limit == limit));
}
...
/// @nodoc
abstract mixin class _$TodosResponseCopyWith<$Res> implements $TodosResponseCopyWith<$Res> {
  factory _$TodosResponseCopyWith(_TodosResponse value, $Res Function(_TodosResponse) _then) = __$TodosResponseCopyWithImpl;
@override @useResult
$Res call({
 List<Todo> todos, int total, int skip, int limit
});
