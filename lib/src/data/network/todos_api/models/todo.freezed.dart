...
extension TodoPatterns on Todo {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String todo, bool completed, int userId)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Todo() when $default != null:
        return $default(_that.id, _that.todo, _that.completed, _that.userId);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(int id, String todo, bool completed, int userId) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _Todo():
